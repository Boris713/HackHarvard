  ...
  return (
    <div>
      ...
      <Container className="py-5">
        <h2 className="mb-4">Governance Page</h2>
        <p>
          Welcome to the Governance page! Here you can find information about companies' governance performance.
        </p>
        ...
        {/* Ranked List Section */}
        <div>
          <h2 className="mb-4">Companies Ranked by Governance Score</h2>
