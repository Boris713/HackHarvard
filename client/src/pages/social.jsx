  ...
  return (
    <div>
      ...
      <Container className="py-5">
        <h2 className="mb-4">Social Page</h2>
        <p>
          Welcome to the Social page! Here you can find information about companies' social performance.
        </p>
        ...
        {/* Ranked List Section */}
        <div>
          <h2 className="mb-4">Companies Ranked by Social Score</h2>
